...
public class EjemploECDSA {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KeyPairGenerator keyGen = KeyPairGenerator.getInstance("ECIES"); // Hace uso del provider BC
        ...
        java.security.spec.ECPrivateKeySpec clavePrivadaSpec = null;//= new java.security.spec.ECPrivateKeySpec(BigInteger.ONE,privateKey);
